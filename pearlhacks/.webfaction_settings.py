...
DATABASES = {
    'default': {
        ...
        'NAME': 'culture_of_yes',                      # Or path to database file if using sqlite3.
...
ROOT_URLCONF = 'capitolHound.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'capitolHound.wsgi.application'
...
#HAYSTACK_SITECONF='capitolHound.search_sites'
#HAYSTACK_SEARCH_ENGINE='default'
HAYSTACK_SIGNAL_PROCESSOR = 'haystack.signals.RealtimeSignalProcessor'
#HAYSTACK_CUSTOM_HIGHLIGHTER = 'capitolHoundApp.utils.BorkHighlighter'
