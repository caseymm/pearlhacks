...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        try:
            ...
            url = 'http://www.dailytexanonline.com/search/site/sexual%20assault' # write the url here
            ...
            story_content = str(soup.find_all('ul', attrs={'class': 'results-list'}));
 
            print story_content
            school_stories = Schools.objects.get(name='The University of Texas at Austin')
