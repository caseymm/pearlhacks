...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        try:
            ...
            url = 'http://www.ndsuspectrum.com/search-1.1674063?q=sexual+assault' # write the url here
            ...
            story_content = str(soup.find_all('ul', attrs={'class': 'searchResults'}));
 
            print story_content
            school_stories = Schools.objects.get(name='North Dakota State University')
