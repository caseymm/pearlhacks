...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        try:
            ...
            url = 'http://www.dailycampus.com/search-box-1.982940?q=sexual+assault&from=MM%2FDD%2FYY&to=MM%2FDD%2FYY' # write the url here
            ...
            story_content = str(soup.find_all('div', attrs={'id': 'content'}));
 
            print story_content
            school_stories = Schools.objects.get(name='The University of Connecticut')
