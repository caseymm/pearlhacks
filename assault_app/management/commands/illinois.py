...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        try:
            ...
            url = 'http://www.dailyillini.com/search/?t=article&s=start_time&sd=desc&d1=1+year+ago&q=sexual+assault' # write the url here
            ...
            print story_content
            school_stories = Schools.objects.get(name='University of Illinois at Urbana-Champaign')
