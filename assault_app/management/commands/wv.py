...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        try:
            ...
            url = 'http://www.thedaonline.com/search/?t=article&nsa=eedition&q=sexual+assault' # write the url here
            ...
            print story_content
            school_stories = Schools.objects.get(name='West Virginia University')
