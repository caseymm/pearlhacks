...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        try:
            ...
            url = 'http://www.vermontcynic.com/search-box-1.1354275?q=sexual+assault' # write the url here
            ...
            print story_content
            school_stories = Schools.objects.get(name='The University of Vermont')
