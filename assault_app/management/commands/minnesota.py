...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        try:
            ...
            url = 'http://www.mndaily.com/search?query=sexual+assault&sa=Search' # write the url here
            ...
            story_content = str(soup.find_all('div', attrs={'id': 'gsc-result'}));
 
            print story_content
            school_stories = Schools.objects.get(name='University of Minnesota')
