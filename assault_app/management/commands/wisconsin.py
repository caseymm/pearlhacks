...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        try:
            ...
            url = 'http://badgerherald.com/?s=sexual+assault' # write the url here
            ...
            story_content = str(soup.find_all('article', attrs={'class': 'news'}));
 
            print story_content
            school_stories = Schools.objects.get(name='The University of Wisconsin Madison')
