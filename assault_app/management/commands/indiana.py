...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        try:
            ...
            url = 'http://www.idsnews.com/news/searchresults.aspx?searchKey=sexual%20assault&p=1' # write the url here
            ...
            story_content = str(soup.find_all('div', attrs={'class': 'stories_and_search_filters'}));
 
            print story_content
            school_stories = Schools.objects.get(name='Indiana University Bloomington')
