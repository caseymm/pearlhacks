...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        try:
            ...
            url = 'http://thelantern.com/?s=sexual+assault&x=0&y=0' # write the url here
            ...
            story_content = str(soup.find_all('div', attrs={'class': 'post-by-2'}));
 
            print story_content
            school_stories = Schools.objects.get(name='Ohio State University')
