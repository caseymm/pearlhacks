...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        try:
            ...
            url = 'http://thedmonline.com/?s=sexual+assault' # write the url here
            ...
            story_content = str(soup.find_all('div', attrs={'class': 'post-wrapper-archive'}));
 
            print story_content
            school_stories = Schools.objects.get(name='University of Mississippi')
