...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        try:
            ...
            url = 'http://www.lsureveille.com/search/?t=article&s=start_time&sd=desc&d1=3+years+ago&q=sexual+assault' # write the url here
            ...
            print story_content
            school_stories = Schools.objects.get(name='Louisiana State University')
