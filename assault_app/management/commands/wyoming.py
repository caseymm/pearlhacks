...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        try:
            ...
            url = 'http://www.uwbrandingiron.com/?s=sexual+assault&x=0&y=0' # write the url here
            ...
            #get_all = str(soup.find_all('div', attrs={'class': 'post'}));
            story_content = str(soup.find_all('div', attrs={'class': 'post'}));
 
            print story_content
            school_stories = Schools.objects.get(name='The University of Wyoming')
