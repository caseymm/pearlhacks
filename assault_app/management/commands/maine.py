...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        try:
            ...
            url = 'http://www.thebatesstudent.com/?s=sexual+assault' # write the url here
            ...
            story_content = str(soup.find_all('div', attrs={'class': 'grid_8'}));
 
            print story_content
            school_stories = Schools.objects.get(name='Bates College')
