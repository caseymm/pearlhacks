...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        try:
            ...
            url = 'http://www.alligator.org/search/?t=article&q=sexual+assault&x=0&y=0' # write the url here
            ...
            print story_content
            school_stories = Schools.objects.get(name='The University of Florida')
