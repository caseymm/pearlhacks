...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        try:
            ...
            url = 'http://www.nyunews.com/?s=sexual+assault' # write the url here
            ...
            story_content = str(soup.find_all('div', attrs={'class': 'news-list'}));
 
            print story_content
            school_stories = Schools.objects.get(name='New York University')
