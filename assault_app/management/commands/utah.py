...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        try:
            ...
            url = 'http://www.dailyutahchronicle.com/?s=sexual+assault' # write the url here
            ...
            story_content = str(soup.find_all('div', attrs={'class': 'masonry'}));
 
            print story_content
            school_stories = Schools.objects.get(name='The University of Utah')
