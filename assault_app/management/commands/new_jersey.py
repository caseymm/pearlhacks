...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        try:
            ...
            url = 'http://dailyprincetonian.com/?s=sexual+assault' # write the url here
            ...
            story_content = str(soup.find_all('div', attrs={'class': 'ui-block-1'}));
 
            print story_content
            school_stories = Schools.objects.get(name='Princton University')
