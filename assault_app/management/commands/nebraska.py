...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        try:
            ...
            url = 'http://www.dailynebraskan.com/search/?t=article&s=start_time&sd=desc&d1=40+years+ago&q=sexual+assault' # write the url here
            ...
            story_content = str(soup.find_all('ul', attrs={'class': 'blox-list'}));
 
            print story_content
            school_stories = Schools.objects.get(name='University of Nebraska')
